...
The "MediaPortal_Application" folder contains executable files that allow users to run the Media Portal application without installation. Download the files and follow the instructions below to start using Media Portal immediately.

## MediaPortal_Source
The "MediaPortal_Source" folder contains the archived source code of Media Portal.

## Team Member Contribution
Special thanks to [Robert Murdock] (https://github.com/RobMurdock515) for their contributions to this project.

## Download and Installation
To download and install Media Portal, follow these steps:
1. [Download](link-to-download) the latest release from the releases page.
